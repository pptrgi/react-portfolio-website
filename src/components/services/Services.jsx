  ...
  const [services, setServices] = useState([
    {
      ...
      description:
        "Do you have an idea for your next great project? Let's make it a reality.",
      serviceInfo: [
          ...
          {services.map((service, index) => {
            return (
              <div key={index} className="group">
                <div className="bg-containerColor pt-[6rem] pb-[2rem] px-[0.25] border-2 border-gray-100 rounded-md h-[400px] group-hover:scale-105 group-hover:border-gray-400 transition-all duration-300">
