...
function Footer() {
  return (
    <footer
      className="bg-containerColor border-t-2 border-t-gray-200 text-center"
      id="footer"
    >
      <div className="container pt-[2rem] pb-[6rem] bg-containerColor">
        <h1 className="text-h2FontSize text-titleColor font-mediumWeight mb-[2rem] bg-containerColor">
          p.Gitonga
        </h1>
        <div className="flex justify-center space-x-4 items-center bg-containerColor mb-[2rem] sm:space-x-6 md:space-x-8 lg:space-x-10">
          <Link
            to="/"
            className="font-normalWeight text-smallFontSize text-titleColor bg-containerColor hover:text-titleColorDark hover:font-semiBolded"
          >
            Home
          </Link>
          <a
        ...
        <div className="text-textColor text-smallFontSize mt-[4.5rem] bg-containerColor">
          Copyright &#169; 2023 p.Gitonga
        </div>
      </div>
    </footer>
  );
