...
import {IoMdClipboard, IoIosSend} from 'react-icons/io';
import {FaTools, FaTasks} from 'react-icons/fa';
...
const Header = () => {
    ...
    return (
      <header className='bg-bodyColor w-full fixed top-0 left-0'>
          <nav className='relative container flex flex-row justify-between items-center h-[3.5rem] z-50 sm:h-[4.5rem'>
              <a href="/" className='font-titleColor font-mediumWeight'>PGitonga</a>
              ...
              >
                  <div className='flex flex-col-reverse items-center text-smallFontSize text-titleColor font-mediumWeight'>
                      <a href="/" className='hover:text-titleColorDark hover:font-semiBolded hover:underline hover:underline-offset-2'>Home</a>
                      <BiHome className='sm:hidden' size={16}/>
                  </div>
