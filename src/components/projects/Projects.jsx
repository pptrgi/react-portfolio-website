    ...
    const [projects, setProjects] = useState([
        {
            ...
            image: <img src='./src/assets/blogwin.png' className='absolute object-cover h-full w-full'/>,
            gitHub: <a href="https://github.com/pptrgi" className='bg-titleColor p-6 px-4 py-2 text-containerColor font-mediumWeight rounded-full hover:bg-titleColorDark'>GitHub {'>'}</a>,
        ...
        },
        {
            ...
            image: <img src='./src/assets/todo.png' className='absolute object-cover h-full w-full'/>,
            gitHub: <a href="#" className='bg-titleColor p-6 px-4 py-2 text-containerColor font-mediumWeight rounded-full hover:bg-titleColorDark'>GitHub {'>'}</a>,
            ...
            techStack: ["React", "Django Rest FrameWork", "Tailwind CSS"]
        },
        {
            id: 3,
            ...
            image: <img src='./src/assets/personal-web.png' className='absolute object-cover h-full w-full'/>,
            gitHub: <a href="#" className='bg-titleColor p-6 px-4 py-2 text-containerColor font-mediumWeight rounded-full hover:bg-titleColorDark'>GitHub {'>'}</a>,
            detailPage: <span href="#" className='bg-titleColor p-6 px-4 py-2 text-containerColor font-mediumWeight rounded-full hover:bg-titleColorDark'>View {'>'}</span>,
        ...
        },
        {
            ...
            image: <img src='./src/assets/no-image.png' className='absolute object-cover h-full w-full opacity-10'/>,
