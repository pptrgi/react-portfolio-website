    ...
    return (
      <div className='text-center'>
          ...
          <form ref={form} onSubmit={sendEmail} className='flex flex-col items-start space-y-[1.5rem] border-2 border-gray-200 py-[2rem] px-[1.5rem] rounded-lg mx-[2rem] sm:w-[350px] md:w-[400px] lg:w-[450px] sm:mx-0'>
              <div className='flex flex-col items-start space-y-1 bg-transparent border-b-[1px] border-titleColor w-full'>
                  <label className='text-titleColor font-mediumWeight'>Your name</label>
                  <input type="text" name='name' className='bg-transparent w-full focus:outline-none text-textColor pl-[0.5rem] placeholder-gray-300' placeholder='e.g. Peter Gitonga' required/>
              </div>
              <div className='flex flex-col items-start space-y-1 bg-transparent border-b-[1px] border-titleColor w-full'>
                  <label className='text-titleColor font-mediumWeight'>Your email</label>
                  <input type="email" name='email' className='bg-transparent w-full focus:outline-none text-textColor pl-[0.5rem] placeholder-gray-300' placeholder='example@email.com' required/>
              </div>
              <div className='flex flex-col items-start space-y-1 bg-transparent border-b-[1px] border-titleColor w-full '>
                  <label className='text-titleColor font-mediumWeight mt-[1rem]'>Your message</label>
                  <textarea rows={5} name='message' className='bg-transparent w-full focus:outline-none text-textColor resize-none pl-[0.5rem] placeholder-gray-300' placeholder='e.g. Example message' required/>
              </div>
