...
function Titles() {
  return (
    <div className='text-center'>
        ...
        <p className='text-textColor text-smallFontSize px-[0.5rem] mb-[3rem] sm:px-[1.5rem] sm:max-w-[300px] md:px-[2rem] md:max-w-md'>A lifelong learner who enjoys creating and designing things that live on the internet, and that might include meme making.</p>
